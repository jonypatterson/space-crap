...
function inferMission(name) {
  ...
  // IoT / AIS / commercial
  if (n.includes('SITRO-AIS')) return 'SHIP TRACKING';
  if (n.includes('SITRO-TD'))  return 'SHIP TRACKING';
  if (n.includes('CONNECTA'))  return 'IOT';
  if (n.includes('ASTROCAST')) return 'IOT';
  if (n.includes('CENTAURI'))  return 'IOT';
  if (n.includes('NASBSAT'))   return 'IOT';
  if (n.includes('SWARM'))     return 'IOT';
  if (n.includes('KEPLER'))    return 'IOT';
  if (n.includes('BRO-'))      return 'SIGNALS INTELLIGENCE';
  if (n.includes('ZORKIY'))    return 'EARTH OBSERVATION';
  ...
  if (n.includes('CATSAT'))    return 'AMATEUR RADIO';
  if (n.includes('PHI-'))      return 'AMATEUR RADIO';
  if (n.includes('RTU MIREA')) return 'AMATEUR RADIO';
  if (n.includes('INSPIRESAT')) return 'AMATEUR RADIO';
  if (n.includes('SCORPION'))  return 'AMATEUR RADIO';
  if (n.includes('SATURN'))    return 'AMATEUR RADIO';
  if (n.includes('UTMN'))      return 'AMATEUR RADIO';
  if (n.includes('QMR-KWT'))   return 'AMATEUR RADIO';
  if (n.includes('NIGHTJAR'))  return 'AMATEUR RADIO';
  if (n.includes('CSTP'))      return 'AMATEUR RADIO';
  if (n.includes('POLYTECH'))  return 'AMATEUR RADIO';
  if (n.includes('SHARJAHSAT')) return 'AMATEUR RADIO';
  if (n.includes('ROBUSTA'))   return 'AMATEUR RADIO';
  if (n.includes('CUBESX'))    return 'AMATEUR RADIO';
  if (n.includes('MONITOR-'))  return 'AMATEUR RADIO';
  if (n.includes('SVYATOBOR')) return 'AMATEUR RADIO';
  if (n.includes('VIZARD'))    return 'AMATEUR RADIO';
  if (n.includes('COLIBRI'))   return 'AMATEUR RADIO';
  if (n.includes('ARCTICSAT')) return 'AMATEUR RADIO';
  if (n.includes('QUBE'))      return 'AMATEUR RADIO';
  if (n.includes('SAKHACUBE')) return 'AMATEUR RADIO';
  if (n.includes('GOMX'))      return 'AMATEUR RADIO';
  if (n.includes('HCT-SAT'))   return 'AMATEUR RADIO';
  if (n.includes('NORBY'))     return 'AMATEUR RADIO';
  if (n.includes('FORESAIL'))  return 'AMATEUR RADIO';
  if (n.includes('GRIFON'))    return 'AMATEUR RADIO';
  if (n.includes('ALMUNTHER')) return 'AMATEUR RADIO';
  if (n.includes('INNOCUBE'))  return 'AMATEUR RADIO';
  if (n.includes('TUSAT'))     return 'AMATEUR RADIO';
  if (n.includes('SUOMI 100')) return 'AMATEUR RADIO';
  if (n.includes('TUSUR'))     return 'AMATEUR RADIO';
  if (n.includes('SPIRIT'))    return 'AMATEUR RADIO';
  if (n.includes('CUBEBEL'))   return 'AMATEUR RADIO';
  if (n.includes('NANOFF'))    return 'AMATEUR RADIO';
  if (n.includes('STRATOSAT')) return 'AMATEUR RADIO';
  if (n.includes('GALAPAGOS')) return 'AMATEUR RADIO';
  if (n.includes('NANOZOND')) return 'AMATEUR RADIO';
  if (n.includes('SINOD'))     return 'AMATEUR RADIO';
  if (n.includes('GORIZONT'))  return 'AMATEUR RADIO';
  if (n.includes('HORIZON'))   return 'AMATEUR RADIO';
  if (n.includes('ASRTU'))     return 'AMATEUR RADIO';
  if (n.includes('MICE-'))     return 'AMATEUR RADIO';
  if (n.includes('UMKA'))      return 'AMATEUR RADIO';
  if (n.includes('GRBBETA'))   return 'AMATEUR RADIO';
  if (n.includes('CUTE-'))     return 'AMATEUR RADIO';
  if (n.includes('UNISAT'))    return 'AMATEUR RADIO';
  if (n.includes('JAS '))      return 'AMATEUR RADIO';
  if (n.includes('FO-'))       return 'AMATEUR RADIO';
  if (n.includes('HADES'))     return 'AMATEUR RADIO';
  if (n.includes('ITUPSAT'))   return 'AMATEUR RADIO';
  if (n.includes('KKS-1'))     return 'AMATEUR RADIO';
  if (n.includes('KISEKI'))    return 'AMATEUR RADIO';
  if (n.includes('UND ROADS')) return 'AMATEUR RADIO';
  if (n.includes('SMDC'))      return 'AMATEUR RADIO';
  if (n.includes('HYDRA'))     return 'AMATEUR RADIO';
  if (n.includes('JACK-'))     return 'AMATEUR RADIO';
  if (n.includes('LUCA'))      return 'AMATEUR RADIO';
  if (n.includes('NUSHSAT'))   return 'AMATEUR RADIO';
  if (n.includes('XW-'))       return 'AMATEUR RADIO';
  if (n.includes('CAS '))      return 'AMATEUR RADIO';
  if (n.includes('REAL'))      return 'AMATEUR RADIO';
  if (n.includes('OTP-'))      return 'AMATEUR RADIO';
  if (n.includes('BALKAN'))    return 'AMATEUR RADIO';
  if (n.includes('DCS-'))      return 'AMATEUR RADIO';
  if (n.includes('HYPERVIEW')) return 'AMATEUR RADIO';
  if (n.includes('A-SEANSAT')) return 'AMATEUR RADIO';
  if (n.includes('BOTSAT'))    return 'AMATEUR RADIO';
  if (n.includes('T-MICROSAT')) return 'AMATEUR RADIO';
  if (n.includes('LUNA-'))     return 'AMATEUR RADIO';
